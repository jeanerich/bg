<div class='modal_mini_panel'>
	<h1><?php echo $this->functions->_e("leave a team", $dictionary); ?></h1>
...
<p><a href='#' onclick="quitBattle(<?php echo $battle_id . "," . $team_id; ?>); return false;" class='button'><?php echo $this->functions->_e("leave this team", $dictionary); ?></a> <a href='#' class='button darker' onclick="close_fs_modal(); return false;"><?php echo $this->functions->_e("cancel", $dictionary); ?></a></p>
</div>